...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/16 10:09:30 by hongbaki          #+#    #+#             */
/*   Updated: 2023/04/16 10:09:31 by hongbaki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (!static_buffer)
		return (NULL);
	//static_buffer = oneline(static_buffer);
	//line = nextline(static_buffer);
