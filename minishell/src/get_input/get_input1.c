...
** @20		Delete the current line from STDOUT (part of the curses library, specifically the terminfo database)
** @21		Set cursor at the beginning of current line (part of the curses library, specifically the terminfo database)
...
standard ASCII (0-127 7bit) character then nb_char_to_delete = 1;
extented ASCII (128-255 8bit) character then nb_char_to_delete = 2; including uppercase and lowercase etc
